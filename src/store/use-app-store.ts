...
export const useAppStore = create<AppState>((set) => ({
    ...
    // Initial Mock Data
    projects: [
        { id: "proj_01", name: "Projeto Alpha", status: "No Prazo", color: "text-primary", involvedMembers: ["john@acme.com", "admin@acme.com"], health: 'on-time', completionRate: 65, methodology: 'AGILE' },
        ...
        { id: "proj_03", name: "Marketing Q3", status: "Adiantado", color: "text-blue-500", involvedMembers: ["john@acme.com", "admin@acme.com"], health: 'ahead', completionRate: 88, methodology: 'LIST' },
